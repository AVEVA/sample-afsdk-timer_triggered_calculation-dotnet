...
[![Build Status](https://dev.azure.com/AVEVA-VSTS/Cloud%20Platform/_apis/build/status%2Fproduct-readiness%2FAFSDK%2FAVEVA.sample-afsdk-timer_triggered_calculation-dotnet?repoName=AVEVA%2Fsample-afsdk-timer_triggered_calculation-dotnet&branchName=main)](https://dev.azure.com/AVEVA-VSTS/Cloud%20Platform/_build/latest?definitionId=16183&repoName=AVEVA%2Fsample-afsdk-timer_triggered_calculation-dotnet&branchName=main)
...
1. For each element in the context list:
    1. The element name is resolved into an [AFElement](https://docs.aveva.com/bundle/af-sdk/page/html/T_OSIsoft_AF_Asset_AFElement.htm) object
...
Calculation Logic:  
1. A [RecordedValuesByCount](https://docs.aveva.com/bundle/af-sdk/page/html/M_OSIsoft_AF_Data_AFData_RecordedValuesByCount.htm) call returns the 100 most recent values each for both `Temperature` and `Pressure`, backwards in time from the triggering timestamp.
1. Bad values are removed from the [AFValues](https://docs.aveva.com/bundle/af-sdk/page/html/T_OSIsoft_AF_Asset_AFValues.htm) object
...
1. `Volume` is a static attribute, so its [end of stream](https://docs.aveva.com/bundle/af-sdk/page/html/M_OSIsoft_AF_Data_AFData_EndOfStream.htm) value is returned
1. Each of these values are used, with the [Gas Constant](https://en.wikipedia.org/wiki/Gas_constant) to determine the number of moles in the reactor
    1. [AF Units of Measure](https://docs.aveva.com/bundle/af-sdk/page/html/N_OSIsoft_AF_UnitsOfMeasure.htm) are used to ensure the values are the expected units, regardless of how they are stored in the underlying PI Points.
...
1. Creates an [AFElementTemplate](https://docs.aveva.com/bundle/af-sdk/page/html/T_OSIsoft_AF_Asset_AFElementTemplate.htm) with the necessary [AFAttributeTemplates](https://docs.aveva.com/bundle/af-sdk/page/html/T_OSIsoft_AF_Asset_AFAttributeTemplate.htm)
1. Creates an element with this template for each name in the conext list
1. Creates the attributes' underlying PI Points with [AFDataReference.CreateConfig](https://docs.aveva.com/bundle/af-sdk/page/html/M_OSIsoft_AF_Asset_AFDataReference_CreateConfig_1.htm)
...
For the main AF SDK Custom Calculations Samples landing page [ReadMe](https://github.com/AVEVA/AVEVA-Samples-PI-System/tree/main/docs/AF-SDK-Custom-Calculations-Docs)  
For the main PI System Samples landing page [ReadMe](https://github.com/AVEVA/AVEVA-Samples-PI-System)  
For the main AVEVA Samples landing page [ReadMe](https://github.com/AVEVA/AVEVA-Samples)
